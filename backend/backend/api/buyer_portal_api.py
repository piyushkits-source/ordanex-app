...
def get_catalog(
    ...
    return buyer_portal_service.get_catalog(db, client_id, buyer_email=buyer_email)
...
def list_orders(
    ...
    return buyer_portal_service.list_orders(db, client_id, buyer_email=buyer_email)
...
def get_access(
    ...
    return buyer_portal_service.get_access_state(db, client_id, buyer_email=buyer_email)
